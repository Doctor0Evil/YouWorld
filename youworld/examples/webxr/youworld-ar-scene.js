async function activateXRWithYouWorldScene() {
  ...
  // YouWorld: register the scene with the platform; this is a stub for the project's public SDK
  await YouWorld.registerScene({ sceneId: "city-block-42", mode: "AR_PANEL" });
  ...
  const onXRFrame = (time, frame) => {
    ...
    for (const view of pose.views) {
      ...
      YouWorld.renderSceneView("city-block-42", view, xrRefSpace, time);
    }
  };
